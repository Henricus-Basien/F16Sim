...
#ifdef IncludeLoFi
    #pragma message "Lofi Model is being imported"
    #include "lofi_F16_AeroData.h"              /* LOFI Look-up header file*/
#else
    #pragma message "Lofi Model is not imported" 
#endif

#ifdef IncludeHiFi
    #pragma message "Hifi Model is being imported"
    #include "hifi_F16_AeroData.h"              /* HIFI Look-up header file*/
#else
    #pragma message "Hifi Model is not imported" 
#endif
